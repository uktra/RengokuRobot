...
PM_START_TEXT = """
`Hello` [🤗](https://telegra.ph/file/6aeea92828ecde808819c.jpg) `My name is` *Tomioka*
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="✨ Our Group", url="https://t.me/anime_dynasty"
        ),
    ],
]
...
HELP_STRINGS = """
`Hi.. I'm` [Tomioka🙋‍♀️](https://telegra.ph/file/6aeea92828ecde808819c.jpg)
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Tomioka*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_Tomika's licensed under the GNU General Public License v3.0_
                 \nHere is the [💾Repository](https://github.com/nksama/tomioka)import datetime
import html
import textwrap
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Tomioka*
                 \nHere is the [Source Code](https://github.com/nksama/tomika) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
